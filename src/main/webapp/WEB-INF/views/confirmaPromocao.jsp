...
<fieldset><legend>PromoÁ„o </legend></fieldset>


<div class=" col-md-12 " >
   <div class="panel  panel-default">
      <div class="panel-heading head-promo">Confirme o cadastro da promoÁ„o</div>
      <div class="panel-body">
         <form class="form-horizontal" name="confirmaProm"  ng-submit="cadProm()">
            <div class="form-group col-md-8" >
               <label for="nomepromocao" class="control-label">Nome da promoÁ„o</label>
               <input type="text" name="nomeprom" ng-model="nomepromo"  class="form-control" >
            </div>
            <div ng-bind="nome">{{nome}}</div>
            <div class="form-group col-md-8">
               <label for="descricao" class="control-label">Descric√£o da promoc√£o</label>
               <div class="">                
                  <input type="text" name="descrprom" ng-model="descrprom" class="form-control">
               </div>
            </div>
            <!--<div class="form-group col-md-8">
               <label for="categoria" class="control-label">Categoria do servi√ßo</label>
              ...
              <div class="form-group col-md-8 form-inline" >
               <label for="categoria" class="control-label">Valor por categoria do servi√ßo</label>
            ...
            <div class="row">
               <div class="col-md-6">
                  <label for="dataini" class="control-label ">Data in√≠cio</label>
                  <p class="input-group">
