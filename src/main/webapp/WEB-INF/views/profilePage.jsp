...
div.ebcs-calendar button, div.ebcs-calendar input, div.ebcs-calendar optgroup,
	div.ebcs-calendar select, div.ebcs-calendar textarea {
	/*color: inherit;
    font: inherit;
    margin: 0;*/
...
div.ebcs-calendar input[type="button"], div.ebcs-calendar input[type="submit"],
	div.ebcs-calendar input[type="reset"], div.ebcs-calendar>button {
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<uib-tabset active="active"> <uib-tab index="0"
										heading="Serviços"
										ng-if="usuarioLogado !='' && tipoUsuarioLogado!=1">
									<br>
									<div class="panel panel-default">
										<div class="panel-body">
											<div
										...
										ng-if="$root.data.listaServicosContratados!=null"> <br>
									<div
										...
										ng-if="$root.data.listaContratosServicosPrestados!=null  && tipoUsuarioLogado!=1 ">
									<br>
									<div
													...
													<div ng-if="amizade.isRecomendacaoDada" style="color: red">
														<button class="btn disabled">
															<table style="color: red;">
																<tr>
																	<td style="padding-right: 10px"><font size="6"><span
																			class="glyphicon glyphicon-heart"></span></font></td>
														...
														<button class="btn disabled">
															<table style="color: green;">
																<tr>
																	<td style="padding-right: 10px"><font size="6"><span
																			class="glyphicon glyphicon-heart"></span></font></td>
																	<td><font size="3">Recomendação <br>Recebida
																	</font></td>
																</tr>
															</table>
														</button>
									...
									</uib-tab> <uib-tab index="4" heading="Avaliação Serviços Contratados"
										ng-if="$root.data.listaServicosContratados!=null"> <br>
									<div class="panel panel-default">
										<div class="panel-body">
											<div
												...
												<div class="col-md-12 col-sm-3 col-xs-6"
													ng-if="compromisso.status == 6">
													<div class="panel panel-default">
														<div class="panel-heading">
															<strong> {{compromisso.contrato.servico.nome}} -
																{{compromisso.contrato.servico.descricao}} </strong>
														</div>
														<div class="panel-body">
															<div class="col-md-3">
																<div class="panel panel-default">
																	...
																	<div class="panel-body">
																		<div style="text-align: center;">
																			<strong>Avaliação <br> Contratante:
																			</strong>
																			<div>
																				<font color="yellow" size="5"> <span
																					class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoContratante>=1"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoContratante>=2"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoContratante>=3"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoContratante>=4"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoContratante>=5"></span>
																				</font>
																			</div>
																		</div>
																	</div>
															...
															<div class="col-md-9">
																<div class="panel panel-default">
																	<div class="panel-heading">
																		<strong> Prestador:
																			{{compromisso.contrato.prestador.nome}} </strong>
																	</div>
																	<div class="panel-body">
																		<div class="col-md-3" style="text-align: center;">

																			<strong>Avaliação <br> Qualidade:
																			</strong>
																			<div>
																				<font color="yellow" size="5"> <span
																					class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoQualidade>=1"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoQualidade>=2"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoQualidade>=3"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoQualidade>=4"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoQualidade>=5"></span>
																				</font>
																			</div>
																		</div>
																		<div class="col-md-3" style="text-align: center;">
																			<strong>Avaliação <br> Preço:
																			</strong>
																			<div>
																				<font color="yellow" size="5"> <span
																					class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoPreco>=1"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoPreco>=2"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoPreco>=3"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoPreco>=4"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoPreco>=5"></span>
																				</font>
																			</div>
																		</div>
																		<div class="col-md-3" style="text-align: center;">
																			<strong>Avaliação <br> Pontualidade:
																			</strong>
																			<div>
																				<font color="yellow" size="5"> <span
																					class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoTempo>=1"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoTempo>=2"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoTempo>=3"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoTempo>=4"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoTempo>=5"></span>
																				</font>
																			</div>
																		</div>
																		<div class="col-md-3" style="text-align: center;">
																			...
																			<div>
																				<font color="yellow" size="5"> <span
																					class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoProfissionalismo>=1"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoProfissionalismo>=2"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoProfissionalismo>=3"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoProfissionalismo>=4"></span>
																					<span class="glyphicon glyphicon-star"
																					ng-if="compromisso.contrato.avaliacaoPrestador.avaliacaoProfissionalismo>=5"></span>
																				</font>
																			</div>
																		</div>
																	</div>
									...
									</uib-tab> <uib-tab index="4" heading="Avaliação Serviços Prestados"
										ng-if="$root.data.listaContratosServicosPrestados!=null  && tipoUsuarioLogado!=1">
									<br>
									<div class="panel panel-default">
										<div class="panel-body">
														...
														<div class="panel-body">
															<div class="col-md-3">
																<div class="panel panel-default">
																	<div class="panel-heading">
																		<strong> Cliente:
																			{{compromisso.contrato.cliente.nome}} </strong>
																	</div>
																	<div class="panel-body">
																		<div style="text-align: center;">
																			<strong>Avaliação <br> Contratante:
									...
									</uib-tab> <uib-tab index="5" heading="Calendário"
										data-ng-init="datasCalendario()"
										ng-if="$root.data.listaContratosServicosPrestados!=null  && tipoUsuarioLogado!=1">
									<br>
									<div class="panel panel-default">
										<div class="panel-body">
